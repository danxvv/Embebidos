...
HD_PWD='/home/daniel/Documents/VHDL/practicaa/practicaa.runs/practica_clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practica_clk_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practica_clk_wiz_1.tcl
