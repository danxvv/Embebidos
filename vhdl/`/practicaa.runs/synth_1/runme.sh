...
HD_PWD='/home/daniel/Documents/VHDL/practicaa/practicaa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practica_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practica_wrapper.tcl
