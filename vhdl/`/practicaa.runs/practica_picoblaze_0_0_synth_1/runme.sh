...
HD_PWD='/home/daniel/Documents/VHDL/practicaa/practicaa.runs/practica_picoblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practica_picoblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practica_picoblaze_0_0.tcl
