...
HD_PWD='/home/daniel/Documents/VHDL/practicaa/practicaa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practica_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practica_wrapper.tcl -notrace
