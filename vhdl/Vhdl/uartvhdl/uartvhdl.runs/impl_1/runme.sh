...
HD_PWD='/home/daniel/Documents/VHDL/uartvhdl/uartvhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uartsys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uartsys_wrapper.tcl -notrace
