...
HD_PWD='/home/daniel/Documents/VHDL/uartvhdl/uartvhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartsys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartsys_wrapper.tcl
