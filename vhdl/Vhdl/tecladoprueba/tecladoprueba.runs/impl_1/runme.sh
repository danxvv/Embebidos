...
HD_PWD='/home/daniel/Documents/VHDL/tecladoprueba/tecladoprueba.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps2.tcl -notrace
