...
HD_PWD='/home/daniel/Dropbox/VH/VIVADO/Maquina_4/Maquina_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maquina_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maquina_4.tcl
