...
HD_PWD='/home/daniel/Documents/VHDL/registro_archivos/registro_archivos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log registrodatos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source registrodatos.tcl
