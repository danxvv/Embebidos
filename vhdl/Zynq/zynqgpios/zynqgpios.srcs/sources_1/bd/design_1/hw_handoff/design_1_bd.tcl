...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GPIO2_BOARD_INTERFACE {shield_dp0_dp13} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports shield_dp0_dp13] [get_bd_intf_pins axi_gpio_0/GPIO2]
