...
HD_PWD='/home/daniel/Documents/VHDL/axipwm/axipwm.runs/design_1_my_pwm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_pwm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_pwm_0_0.tcl
