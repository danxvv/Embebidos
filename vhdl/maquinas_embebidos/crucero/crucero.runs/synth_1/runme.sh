...
HD_PWD='C:/Users/darko/OneDrive/Documentos/VH/crucero/crucero.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crucer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crucer.tcl
