...
HD_PWD='C:/Users/darko/OneDrive/Documentos/VH/crucero/crucero.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log crucer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source crucer.tcl -notrace
