...
--Command     : generate_target zynqprueba_wrapper.bd
--Design      : zynqprueba_wrapper
...
end zynqprueba_wrapper;

architecture STRUCTURE of zynqprueba_wrapper is
  component zynqprueba is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
zynqprueba_i: component zynqprueba
     port map (
